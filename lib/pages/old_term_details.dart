...
class OldTermDetailsPage extends StatefulWidget {
  const OldTermDetailsPage({super.key});

  @override
  State<StatefulWidget> createState() => OldTermDetailsPageState();
}

class OldTermDetailsPageState extends State<OldTermDetailsPage> {
  String termName = '';
